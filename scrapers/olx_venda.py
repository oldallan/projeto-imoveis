...
BASE_URL = "https://www.olx.com.br/imoveis/venda/estado-sp/sao-paulo-e-regiao"
DEFAULT_OUTPUT_PATH = build_dated_output_path("olx", "olx_venda.csv")
...
def run(
    ...
    if not records:
        print("[WARN] OLX venda sem dados coletados")
        return None
