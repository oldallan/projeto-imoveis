...
BASE_API_URL = "https://apis.lopes.com.br/portal-home/v2/search/cache/sale/br/sp/sao-paulo"
DEFAULT_OUTPUT_PATH = build_dated_output_path("lopes", "lopes_venda.csv")
...
def run(
    ...
    if not records:
        print("[WARN] Lopes venda sem dados coletados")
        return None
