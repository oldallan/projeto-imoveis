...
from scrapers.quinto_discovery import collect_discovery_to_file
from scrapers.quinto_listings import collect_listings_from_file


DEFAULT_DISCOVERY_OUTPUT_PATH = build_dated_output_path("quinto", "quinto_discovery.csv")
DEFAULT_DISCOVERY_PARQUET_OUTPUT_PATH = str(Path(DEFAULT_DISCOVERY_OUTPUT_PATH).with_suffix(".parquet"))
DEFAULT_LISTINGS_OUTPUT_PATH = build_dated_output_path("quinto", "quinto_listings.csv")
