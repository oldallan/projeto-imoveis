...
from scrapers.olx_discovery import collect_discovery_to_file
from scrapers.olx_listings import collect_listings_from_file
from scrapers.output_paths import build_dated_output_path


DEFAULT_DISCOVERY_OUTPUT_PATH = build_dated_output_path("olx", "olx_discovery.csv")
DEFAULT_DISCOVERY_PARQUET_OUTPUT_PATH = str(Path(DEFAULT_DISCOVERY_OUTPUT_PATH).with_suffix(".parquet"))
DEFAULT_LISTINGS_OUTPUT_PATH = build_dated_output_path("olx", "olx_listings.csv")
