...
BASE_PAGE_URL = "https://www.quintoandar.com.br/comprar/imovel/sao-paulo-sp-brasil"
DEFAULT_OUTPUT_PATH = build_dated_output_path("quinto", "quinto_venda.csv")
...
def run(
    ...
    if not records:
        print("[WARN] QuintoAndar venda sem dados coletados")
        return None
